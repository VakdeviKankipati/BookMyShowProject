...
//        show.setMovie(movie);
    ...
    public void testBookTicket_2_Request_Success_Non_overlapping_seats() throws Exception {
        ...
        assertEquals(ShowSeatStatus.BLOCKED, showSeats.get(0).getShowSeatStatus(), "Seat status should be BLOCKED");
        assertEquals(ShowSeatStatus.BLOCKED, showSeats.get(1).getShowSeatStatus(), "Seat status should be BLOCKED");
        assertEquals(ShowSeatStatus.BLOCKED, showSeats.get(2).getShowSeatStatus(), "Seat status should be BLOCKED");
        assertEquals(ShowSeatStatus.BLOCKED, showSeats.get(3).getShowSeatStatus(), "Seat status should be BLOCKED");
    }
